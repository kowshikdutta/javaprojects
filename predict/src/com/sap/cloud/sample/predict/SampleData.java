...
/**
 * Servlet implementation class SampleData
 */
public class SampleData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String path = contextpath +"sampledata" + fileSeparator + "SampleFile.txt";
		File fileSample = new File(path);
		BufferedReader br = new BufferedReader(new FileReader(fileSample));
		response.setContentType("text/plain");
		response.setHeader("Content-Disposition", "attachment;filename=\"SampleFile.txt\"");
